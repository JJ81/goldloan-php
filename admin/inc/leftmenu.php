...
<!--                </li>-->
<!--                <li>-->
<!--                    <a class="has-arrow" href="--><?php //echo ROOT;?><!--admin/blog/list.php" aria-expanded="false">-->
<!--                        <i class="far fa-edit"></i>-->
<!--                        <span class="hide-menu">블로그-->
<!--                        </span>-->
<!--                    </a>-->
<!--                </li>-->

                <li>
                    <a class="has-arrow" href="<?php echo ROOT;?>admin/faq/list.php" aria-expanded="false">
                        <i class="fas fa-exclamation-circle"></i>
                        <span class="hide-menu">FAQ
                        </span>
                    </a>
                </li>
<!---->
