...
$query='select * from `cms_board_faq` order by `id` desc limit 0, 1000;';
$rows = $db->query($query);
$db=null;
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">FAQ</h3></div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title clearfix">
                            <h4>FAQ</h4>
                            <a href="<?php echo ROOT;?>admin/faq/write.php" class="btn btn-sm btn-info pull-right">글쓰기</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php }else{ ?>
                                        <?php foreach ($rows as $r) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo ROOT;?>admin/faq/view.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-primary">보기</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
